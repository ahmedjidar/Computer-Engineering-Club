...
<div className="testimonials-container">
	...
	<div className='containerdetails'>
		...
		<div className="centered-items">
			<img className="logo" src={toumi} alt="logo" />
			<div className="user-details">
				<h4 className="username">Toumi Bouchentouf</h4>
				<p className="role">head of computer engineering sector</p>
			</div>
		</div>
	</div>
</div>
...
<div className="testimonials-container">
	...
	<div className='containerdetails'>
		<p className="testimonial">
		"I've had the pleasure of reviewing the Computer Science Club website crafted by our students, and it is truly commendable. The attention to detail in implementing functionality, from interactive coding challenges to event registration, demonstrates a high level of technical proficiency. Moreover, the website's sleek and modern design reflects a keen eye for aesthetics. The students have not only developed a valuable resource for the club but have also showcased their ability to apply theoretical knowledge to real-world projects. Kudos to the team for their outstanding work!"	</p>
		<br />
		<div className="centered-items">
		<img className="logo" src={ennaki} alt="logo" />
			<div className="user-details">
				<h4 className="username">Ihab Abdelbasset Annaki</h4>
				<p className="role">Web developement Professor</p>
			</div>
		</div>
	</div>
</div>
