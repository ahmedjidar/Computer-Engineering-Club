...
const Team = () => {
    ...
    <div className="container-fluid">
      <div className="heading_container heading_center">
        <h2 className="">
           <h1 className="ourteam"> Founders</h1>
        </h2>
      </div>
      ...
      <div className="team_container">
        <div className="row">
          <div className="col-lg-3 col-sm-6">
            <div className="box ">
              <div className="img-box">
                <img src={prs1} className="img1" alt=""/>
              </div>
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="box ">
              <div className="img-box">
                <img src={prs2} className="img1" alt=""/>
              </div>
              <div className="detail-box">
                <h5>
                  Khartouch Mouad
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="box ">
              <div className="img-box">
                <img src={prs3} className="img1" alt=""/>
              </div>
              <div className="detail-box">
                <h5>
                  Jidar Ahmed Amin
          ...
          <div className="col-lg-3 col-sm-6">
            <div className="box ">
              <div className="img-box">
                <img src={prs4} className="img1" alt=""/>
              </div>
              <div className="detail-box">
                <h5>
                  Khribech Hamza
