...
export function AddRepley({userImg,syncPosts,userId,postId,commentId ,forum}) {
    ...
    <>
      ...
      >
        ...
        <button type="submit" className="m-0 p-0 max-w-fit" >
          {loading ? '...' :
         <svg xmlns="http://www.w3.org/2000/svg" fill={forum?"#5d7291":'none'}  viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-5 h-5 text-gray-500">
