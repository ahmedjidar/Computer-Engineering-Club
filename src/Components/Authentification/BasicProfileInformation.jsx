...
import GiLogo from '../../assets/Images/gi.png'
          ...
          <div className="sm:col-span-3">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                <img
                  src={profilePic || UserCircleIcon}
                  alt="Profile"
                  className="h-16 w-16 text-gray-300 rounded-full shadow-md"
                />
                <input
                  type="file"
                  id="photo"
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <h2 className="text-xl font-semibold leading-7 text-gray-900 mb-2">
              ...
              <button
                type="button"
                className="text-sm font-semibold leading-6 text-gray-900 mt-2 bg-slate-100 hover:bg-slate-50 rounded p-2"
