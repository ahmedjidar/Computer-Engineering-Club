    ...
    <div className="w-full flex justify-between">
      ...
      <Card className="w-full flex items-center justify-center p-4">
        ...
        <ListGroup className="list-group-flush">
          <ListGroup.Item className="text-gray-400 text-sm">Computer Engineering Club</ListGroup.Item>
        </ListGroup>
        <Card.Body className="mt-4">
          <Card.Link href="#" className="text-blue-600 border-l-2 border-l-blue-600 px-2">Home</Card.Link>
          <Card.Link href="#" className="text-blue-600 border-l-2 border-l-blue-600 px-2">Team</Card.Link>
        </Card.Body>
      </Card>
      {/* card ends here */}
      </div>
      <form className="basis-3/5 p-20 border-l-4 border-l-blue-500 rounded-xl">
        <div className="space-y-12">
              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  <div className="flex rounded-md ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600 sm:max-w-md">
                    <span className="flex select-none items-center pl-3 text-gray-500 sm:text-sm">computesphere.com/</span>
                    <input
                      type="text"
                      name="username"
                      id="username"
                  ...
                  <div className="text-center">
                    ...
                    <div className="mt-4 flex text-sm leading-6 text-gray-600">
                      ...
                      >
                        ...
                        <input id="file-upload" name="image" type="file" className="outline-none sr-only" />
                      </label>
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">Use a permanent phone number</p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-600 sm:max-w-md">
                      <span className="flex select-none items-center pl-3 text-gray-500 sm:text-sm">+212 </span>
                      <input
                        type="number"
                        name="phone"
                        id="phone"
